const { Challenge, Challenge_Coin_Data, Coin, Portfolio, Portfolio_Coin_Entry } = require('../models');
...
router.get('/portfolio/:id', async (req, res) => {
  ...
  try {
    ...
    for (const entry of portfolioEntries) {
      ...
      const coinValues = coinEntries.filter(coin => coin.coin_id == entry.coin_id)[0];
      console.log(coinValues);
      console.log(entry.amount,coinValues.start_value);
